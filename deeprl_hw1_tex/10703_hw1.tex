...
Therefore, $|A|=4$
 ...
 % unless a wall constrains movement in a particular direction. We have the following number of states with 0,1,2,3,4 possible transitions:

% \begin{itemize}
%   \item \textit{0 transitions:} 0 cells
%   \item \textit{1 transitions:} 1 cell (only the final state at (6,6))
%   \item \textit{2 transitions:} 15 cells 
%   \item \textit{3 transitions:} 18 cells
%   \item \textit{4 transitions:} 2 cells
% \end{itemize}

% Therefore, counting all possible $(S,A)$ pairs we have $|A|=0\times0+1\times1+2\times15+3\times18+4\times2=93$ different state-action pairs.
...
\item What is the optimal policy? Draw the grid and label each cell
  ...
  \begin{tikzpicture}
    ...
    \foreach \x in {1, ..., 6}
      ...
      \path (.5cm,1.5cm) edge [->](.5cm,1.0cm);
      \path (.5cm,2.5cm) edge [->](.5cm,2.0cm);

      \path (1.5cm,1.5cm) edge [->](1.5cm,1.0cm);
      \path (1.5cm,2.5cm) edge [->](1.5cm,2.0cm);

      \path (2.5cm,1.5cm) edge [->](2.5cm,1.0cm);
      \path (2.5cm,2.5cm) edge [->](2.5cm,2.0cm);

      \path (3.5cm,1.5cm) edge [->](4.0cm,1.5cm);
      \path (3.5cm,2.5cm) edge [->](4.0cm,2.5cm);

      \path (4.5cm,1.5cm) edge [->](5.0cm,1.5cm);
      \path (4.5cm,2.5cm) edge [->](5.0cm,2.5cm);

      \path (.5cm,.5cm) edge [->](1cm,.5cm);
      \path (1.5cm,.5cm) edge [->](2cm,.5cm);
      \path (2.5cm,.5cm) edge [->](3cm,.5cm);
      \path (3.5cm,.5cm) edge [->](4cm,.5cm);
      \path (4.5cm,.5cm) edge [->](5cm,.5cm);

      \path (5.5cm,.5cm) edge [->](5.5cm,1cm);
      \path (5.5cm,1.5cm) edge [->](5.5cm,2cm);
      \path (5.5cm,2.5cm) edge [->](5.5cm,3cm);

      \path (5.5cm,3.5cm) edge [->](5cm,3.5cm);
      \path (4.5cm,3.5cm) edge [->](4cm,3.5cm);
      \path (3.5cm,3.5cm) edge [->](3cm,3.5cm);
      \path (2.5cm,3.5cm) edge [->](2cm,3.5cm);
      \path (1.5cm,3.5cm) edge [->](1cm,3.5cm);

      \path (0.5cm,3.5cm) edge [->](0.5cm,4cm);
      \path (0.5cm,4.5cm) edge [->](0.5cm,5cm);

      \path (0.5cm,5.5cm) edge [->](1cm,5.5cm);
      \path (1.5cm,5.5cm) edge [->](2cm,5.5cm);
      \path (2.5cm,5.5cm) edge [->](3cm,5.5cm);
      \path (3.5cm,5.5cm) edge [->](4cm,5.5cm);
      \path (4.5cm,5.5cm) edge [->](5cm,5.5cm);

      \path (1.5cm,4.5cm) edge [->](2cm,4.5cm);
      \path (2.5cm,4.5cm) edge [->](3cm,4.5cm);
      \path (3.5cm,4.5cm) edge [->](4cm,4.5cm);
      \path (4.5cm,4.5cm) edge [->](5cm,4.5cm);

      \path (5.5cm,4.5cm) edge [->](5.5cm,5cm);
